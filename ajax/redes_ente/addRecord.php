...
$id_user=$_SESSION['id'];
    ...
    while($row_ente=mysqli_fetch_array($run_select)){
        $id_ente=$row_ente['id_ente_cultural'];
         $insert_red_soc = "insert into entes_redes_sociales (url_red_social, redes_sociales_id_redes_sociales, entes_culturales_id_ente_cultural) values 
  ('$url','$redes_sociales','$id_ente')" or die($insert_red_soc);
