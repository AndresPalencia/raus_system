...
$gestion="SELECT 
    pautas.id_contrato,
    pautas.entes_culturales_id_ente_cultural,
    usuarios.numero_unico_registro,
     artistas_urbanos.aka, 
     parroquias.parroquia , 
     (CASE pautas.gestion WHEN 'e' THEN 'Emitido' ELSE 'Recibido' END)as gestion
    FROM pautas 
    INNER JOIN artistas_urbanos on pautas.artistas_urbanos_id_artistas=artistas_urbanos.id_artistas 
    INNER JOIN usuarios on artistas_urbanos.usuarios_id_usuario=usuarios.id_usuario 
    INNER JOIN parroquias on usuarios.parroquias_id_parroquia=parroquias.id_parroquia 
    WHERE pautas.entes_culturales_id_ente_cultural='$id_ente'";
